...
const Signup = () => {
    ...
    *========================================================================**/
    ...
    const userSignupFunction = async () => {
        ...
        // validation
        if (userSignup.name === "" || userSignup.email === "" || userSignup.password === "" || userSignup.mobile === "") {
            toast.error("All fields are required");
            return;
        }
        ...
        if (!mobileRegex.test(userSignup.mobile)) {
            toast.error("Mobile number must be exactly 10 digits and contain only numbers");
            return;
        }
